...
async def on_message(message):
	...
	if len(mes) >= max_length: # The message (mes) doesn't fit in one tweet
		...
		tweet(parts[0], image) # Tweets first part without referring to latest item in timeline, including potential image
	...
	else: tweet(mes, image) # Calls tweet function, including potential image
